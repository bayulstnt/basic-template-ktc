                ...
                <div class="card-body">
                    <form method="post" action="<?= base_url()?>transaksi/simpan">
                        <div class="form-group">
                            <input type="text" name="kode_transaksi" value="<?= "TR".date('Ymd_').$kode_transaksi;?>" class="form-control" readonly>
                        </div>
                        ...
                        <div class="form-group">
                           ...
                           <a href="<?= base_url()?>transaksi/tambah" class="btn btn-danger">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
