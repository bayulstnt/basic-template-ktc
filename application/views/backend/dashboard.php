...
<head>
    ...
    <title>Bunda Laundry - Dashboard</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-dark topbar mb-4 static-top shadow" style="background-image: linear-gradient(#270404, #800000);">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; 2022 - Bunda Laundry.</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
